    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-5xl mx-auto">
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <div className="text-gray-700 leading-relaxed space-y-4">
                  ...
                  <p>
                    كما تسعى المنصة إلى مساعدة الباحثين عن عمل على تطوير مهاراتهم والوصول إلى وظائف بمرتبات أعلى وفرص أفضل، من خلال أدوا ذكية وخدمات مميزة مثل توليد السيرة الذاتية ورسائل التوظيف باستخدام الذكاء الاصطناعي.
                  </p>
                  <p className="text-lg">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    جميع الإعلانات مؤكدة المصدر ن الوزارات والمؤسسات الرسمية والشركات الكبرى
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* Disclaimer Notice */}
          <div className="bg-yellow-50 border-r-4 border-yellow-400 rounded-lg shadow-md p-6 mb-8">
            <p className="text-gray-700 text-center leading-relaxed">
              نحن في منصة وظائف عُمان نعمل بشكل مستقل، ولا نرتبط بأي جهة حكومية.
            </p>
            <p className="text-gray-700 text-center leading-relaxed mt-2">
              جميع الإعلانات تُنشر كما وردت من مصادرها الرسمية، والمحتوى يعكس آراء ومعلومات الجهات المعلِنة فقط.
            </p>
          </div>
