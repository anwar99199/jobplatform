...
export function PremiumPage() {
  ...
  const premiumFeatures = [
    ...
    },
    {
      ...
      title: "تشابه تخصصك مع الوظائف",
      description: "اعرف مدى تشابه تخصصك مع كل وظيفة قبل التقديم بتحليل ذكي دقيق",
      features: [
        "تحليل دقيق لتشابه التخصص مع متطلبات الوظيفة",
        "مقارنة المهارات المطلوبة بمهاراتك",
        "توصيات مخصصة للتحسين",
        "نسبة مئوية واضحة للتشابه"
      ],
